...
class TestUtilLogging(unittest.TestCase):	#pylint: disable=R0904
	...
	def test_logger_wrong_type(self):	#pylint: disable=C0103
		...
		"""
		self.assertRaisesRegexp(TypeError, r'logger must be a logger object', util_logging._Plogger, None, 12345)	#pylint: disable=W0212

	def test_name_wrong_type(self):	#pylint: disable=C0103
		"""
		Test correct type of name if passed
		"""
		self.assertRaisesRegexp(TypeError, r'name must be a string', util_logging._Plogger, 12345)	#pylint: disable=W0212

	def test_log_level_type(self):	#pylint: disable=C0103
		"""
		Test correct type of log_level if passed
		"""
		self.assertRaisesRegexp(TypeError, r'log_level must be an integer or a string', util_logging._Plogger, __name__, None, 1+3j)	#pylint: disable=W0212

	def test_log_level_wrong_int(self):	#pylint: disable=C0103
		"""
		Test correct integer value of log_level if passed
		"""
		self.assertRaisesRegexp(ValueError, r'log_level must be an integer in \[10, 20, 30, 40, 50, 60\]', util_logging._Plogger, __name__, None, -35)	#pylint: disable=W0212

	def test_log_level_wrong_str(self):	#pylint: disable=C0103
		"""
		Test correct string value of log_level if passed
		"""
		self.assertRaisesRegexp(ValueError, r'log_level must be an integer in \[DEBUG, INFO, WARNING, ERROR, CRITICAL, NONE\]', util_logging._Plogger, __name__, None, 'a')	#pylint: disable=W0212

	def test_log_file_type(self):	#pylint: disable=C0103
		"""
		Test correct type of log_file if passed
		"""
		self.assertRaisesRegexp(TypeError, r'log_file must be a string', util_logging._Plogger, __name__, None, 60, 3)	#pylint: disable=W0212

	def test_log_file_cannot_be_opened(self):	#pylint: disable=C0103
		"""
		Test correct type of log_file if passed
		"""
		self.assertRaisesRegexp(IOError, r'log_file cannot be opened', util_logging._Plogger, __name__, None, 60, './nodir/test.log')	#pylint: disable=W0212
	...
	def test_log_level_int_works(self):	#pylint: disable=C0103
		...
		"""
		test_logger = util_logging._Plogger('tlog1', None, 'DEBUG')	#pylint: disable=W0212
	...
	def test_log_file_works(self):	#pylint: disable=C0103
		...
		result = True if (test_logger.log_file() == os.path.abspath(new_file_name)) and (util_logging._find_logger_basefilename(test_logger.logger()) == os.path.abspath(new_file_name)) else False	#pylint: disable=W0212
		self.assertTrue(result)
	...
	def test_logger_works(self):
		...
		"""
		log_file = './test.log'
		test_logger1 = util_logging._Plogger('tlog1', None, 'INFO', log_file)	#pylint: disable=W0212
		test_logger2 = util_logging._Plogger('tlog2', None, 'debug')	#pylint: disable=W0212
