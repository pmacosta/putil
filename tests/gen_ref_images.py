...
import itertools, math, numpy, os, sys
...
def unittest_series_images(mode=None, test_dir=None, _timeit=False):	#pylint: disable=R0914
	...
	ref_dir = os.path.join(os.path.dirname(os.path.realpath(os.path.dirname(__file__))), 'tests', 'support', 'ref_images') if mode == 'ref' else test_dir
