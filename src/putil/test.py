...
def evaluate_exception_method(emspec_list, cobj=None, offset=0, ekwargs=None):	#pylint: disable=R0914
	 ...
	 * **kwargs** `(dictionary)` -- Arguments required for pseudo-type initialization. `None` or empty object if not needed, can be omitted if no arguments are required to initialize the pseudo-type
